---
layout: page
title: 'Roadmap v2.11 Documentation'
permalink: /versions/v2.11/
sortable_version: 211
---
## Table of contents
<!--ts-->
...
<!-- Added by: j.benoit, at: Thu Apr  3 16:48:08 PDT 2025 -->
...
Roadmap was first developed in 2019 by Caleb Braun, Lingzhi Jin, and Josh Miller. Version 2.11 was developed in 2025 by Jonny Benoit and Gabe Hillman Alvarez.
...
<img src="/assets/faz_surv.svg" style="width:6.5in;height:4.03958in" />
...
<img src="/assets/high_ems_age_effects.svg" style="width:5.07441in;height:3.32385in" />
...
``` math
{SO}_{2}(g) = \ FC(g)\  \times \ \lbrack S\rbrack(ppm) \times \ \frac{{MW}_{{SO}_{2}}\ }{{MW}_{S}}\  \times \ f{SO}_{2}\  \times \ \left( \frac{10^{6}}{ppm} \right)
```
...
- $`\frac{{MW}_{{SO}_{2}}\ }{{MW}_{S}}`$ = the ratio of molecular weight of sulfur dioxide to sulfur = 2.0
...
<button name='download' onclick="location.href='../Roadmap v2.11 Model Documentation.pdf'">Download as PDF</button>
