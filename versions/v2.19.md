---
layout: page
title: 'Roadmap v2.19 Documentation'
permalink: /versions/v2.19/
sortable_version: 219
---
## Table of contents
<!--ts-->
...
<!-- Added by: s.walzergoldfeld, at: Fri Dec 12 15:56:30 EST 2025 -->
...
Roadmap was first developed in 2019 by Caleb Braun, Lingzhi Jin, and Josh Miller. Version 2.19 was developed in 2025 by Stefan Walzer-Goldfeld, Jonathan Benoit, and Gabe Hillman Alvarez.
...
| [&gt;15 campaigns in various European regionsLet’s use the same language as below, ‘&gt;15 campaigns in various European regions’](https://www.trueinitiative.org/publications) | PM<sub>2.5</sub>, NO<sub>x</sub>, CO, NH<sub>3</sub> | HDV, LDV           |
...
<button name='download' onclick="location.href='../Roadmap v2.19 Model Documentation.pdf'">Download as PDF</button>
