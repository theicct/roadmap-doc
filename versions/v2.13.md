---
layout: page
title: 'Roadmap v2.13 Documentation'
permalink: /versions/v2.13/
sortable_version: 213
---
## Table of contents
<!--ts-->
...
<!-- Added by: j.benoit, at: Thu Jun 26 14:24:43 PDT 2025 -->
...
Roadmap was first developed in 2019 by Caleb Braun, Lingzhi Jin, and Josh Miller. Version 2.13 was developed in 2025 by Jonathan Benoit, Stefan Walzer-Goldfeld, and Gabe Hillman Alvarez.
## Sales
...
Emission factors for European-based vehicle standards are applied both in Europe and other regions that follow the EU regulatory pathway; region-specific adjustments are made wherever sufficient real-world measurements are available. Data from more than 15 TRUE remote-sensing campaigns in various European regions are combined into a unified set of PM<sub>2.5</sub> and NO<sub>x</sub> emission factors, which form the basis of these emission factors.

For heavy-duty trucks and buses, emission factors are observed to vary significantly across different road types (highway, suburban, urban), so we calculate an average emission factor weighted by road type activity shares using data from HBEFA. Because heavy-duty trucks were sampled predominantly on urban roads, highway and suburban road type emission factors for HDTs are estimated by using the ratio of urban to non-urban emission factors from EMEP. For light-duty vehicles, fuel-specific emission factors are observed to vary minimally across different road types, so no such adjustments were necessary.

For all vehicle types, the ages of Euro 5/V and later vehicles captured in remote-sensing campaigns were below the age threshold for full deterioration; in these cases, deterioration adjustments were made to obtain accurate lifetime average emission factors starting from the base year of the model. We calculate those lifetime average emission factors using the average age of vehicles measured, default survival curves, and emission factor deterioration values informed by MOVES4, [Davison et al. 2022](https://www.sciencedirect.com/science/article/pii/S2590162122000168), [Borken-Kleefeld and Chen, 2015](https://www.sciencedirect.com/science/article/pii/S1352231014008723), and [Chen and Borken-Kleefeld, 2016](https://pure.iiasa.ac.at/id/eprint/12290/1/Chen_BorKlee_Diesel%20deterioration%20manuscript_EST.pdf). PM<sub>2.5</sub> emission factors are also broken down into emission factors for each component of PM<sub>2.5</sub> using MOVES 2014a PM<sub>2.5</sub> speciation fractions.
...
<button name='download' onclick="location.href='../Roadmap v2.13 Model Documentation.pdf'">Download as PDF</button>
