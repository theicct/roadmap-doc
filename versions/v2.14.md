---
layout: page
title: 'Roadmap v2.14 Documentation'
permalink: /versions/v2.14/
sortable_version: 214
---
## Table of contents
<!--ts-->
...
Roadmap was first developed in 2019 by Caleb Braun, Lingzhi Jin, and Josh Miller. Version 2.14 was developed in 2025 by Jonathan Benoit and Gabe Hillman Alvarez.
...
The EU, USA, China, and India each have baseline stock by age and survival curves for stock turnover.. Survival curves for China are calculated based on the average retirement age for each vehicle type. The EU data are derived from ACEA for PC and LCV till 2023 and from [ACEM](https://www.acem.eu/market-data) for MC till 2023. For HDVs (MDT, HDT, Bus), data till 2023 are from an internal compilation of stock data from ACEA that is disaggregated by age using sales data from the IHS and IEA’s Mobility Model. For the USA, the stock by age and survival curves data come from MOVES4 and for India, the same data are from IEM with additional inputs from transportation sector experts in the country. Lastly, the China stock by age and survival curve data is derived from an internal meta analysis of data from VECC and China statistical yearbook.
