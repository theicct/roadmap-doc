---
layout: page
title: 'Roadmap v2.17 Documentation'
permalink: /versions/v2.17/
sortable_version: 217
---
## Table of contents
<!--ts-->
...
<!-- Added by: s.walzergoldfeld, at: Fri Aug 29 13:12:35 EDT 2025 -->
...
Roadmap was first developed in 2019 by Caleb Braun, Lingzhi Jin, and Josh Miller. Version 2.17 was developed in 2025 by Stefan Walzer-Goldfeld, Gabe Hillman Alvarez, and Arijit Sen.
...
Deterioration values for the US come directly from MOVES4 for all species and model years 2015 and later. For Mexico, light-duty gasoline CO, NOx and PM deterioration values, as well as heavy-duty diesel PM, come directly from MOVES-Mexico inputs provided by ERG. For all other species, vehicles, and model years that were not directly provided, US and Mexico emission factor deterioration are calculated for by normalizing emission factors over time to the youngest age values in the MOVES4 and MOVES-Mexico datasets.
...
<button name='download' onclick="location.href='../Roadmap v2.17 Model Documentation.pdf'">Download as PDF</button>
