---
layout: page
title: 'Roadmap v2.7 Documentation'
permalink: /versions/v2.7/
sortable_version: 207
---
## Table of contents
<!--ts-->
...
<!-- Added by: g.alvarez, at: Fri Oct 11 12:54:21 PDT 2024 -->
...
Roadmap was first developed in 2019 by Caleb Braun, Lingzhi Jin, and Josh Miller. Version 2.7 was developed in 2024 by Jonathan Benoit and Gabe Hillman Alvarez.
...
Further adjustments were made to the PM and NOx emission factors certified to US and EU regulatory pathways based on real-world performance data, including remote sensing measurements, recent PEMS testing, and planned updates to MOVES. For NOx, the MOVES4-based emission factors for the US are adjusted to align with real-world emissions from The Real Urban Emissions Initiative ([TRUE](https://www.trueinitiative.org/)). Roadmap also supports additional speciation of PM<sub>2.5</sub> for all regions into components BC, OC, non-carbon organic matter, NO<sub>3</sub>, NH<sub>4</sub>, SO<sub>4</sub>, elemental metals, and unspeciated PM, based on Table C-1 and Table C-3 of [MOVES 2014](https://cfpub.epa.gov/si/si_public_file_download.cfm?p_download_id=525697&Lab=OTAQ)a. For the US only, no PM speciation is required, because MOVES4 provides detailed emission factors for the components directly.
...
<button name='download' onclick="location.href='../Roadmap v2.7 Model Documentation.pdf'">Download as PDF</button>
